...
const Tim = () => {
  return (
    <section className="max-container padding-container gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row bg-[#f0f0f0]">
      <div className="text-center bold-32 text-black pb-20" >Rewana Tim</div>
